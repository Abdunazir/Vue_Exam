<template>
  <div class="">
    <AppModal v-model="dialog">
      ...
      <div v-else-if="!forms._id" class="bg-d">
        <h1 class="text-center text-light">Add User</h1>
        <Form @submit="save">
          <Field
            rules="required"
      ...
      <div v-else>
        ...
        <Form @submit="save">
          ...
          <Field
            ...
            name="IsDiploma"
          >
            <select v-model="forms.is_diploma" class="form-control in ">
              <option value="false">false</option>
              <option value="true">true</option>
            </select>
            <p class="text-danger" v-if="errors && errors.length">
...
textarea,.in {
  ...
  border: 1px solid rgb(181, 180, 245);
  color: white;
}
</style>
